...
export const metadata: Metadata = {
  ...
  title: "NeuroPublisher - Маркетплейс",
  description: "Маркетплейс NeuroPublisher: товары, услуги и многое другое. Качественные товары и отличный сервис.",
  keywords: [
    "neuropublisher",
    "маркетплейс",
    "товары",
...
export default function UkrainianLayout({
  ...
  return (
    <html lang="ru" suppressHydrationWarning className={PROJECT_SETTINGS.defaultTheme}>
      <head>
