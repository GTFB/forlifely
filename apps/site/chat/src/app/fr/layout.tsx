...
export const metadata: Metadata = {
  ...
  title: "NeuroPublisher - Marché",
  description: "Marché NeuroPublisher : produits, services et plus encore. Produits de qualité et service excellent.",
  keywords: [
    "neuropublisher",
    "marché",
    "produits",
...
export default function FrenchLayout({
  ...
  return (
    <html lang="fr" suppressHydrationWarning className={PROJECT_SETTINGS.defaultTheme}>
      <head>
