...
export const metadata: Metadata = {
  ...
  title: "NeuroPublisher - Mercado",
  description: "Mercado NeuroPublisher: productos, servicios y más. Productos de calidad y servicio excelente.",
  keywords: [
    "neuropublisher",
    "mercado",
    "productos",
...
export default function SpanishLayout({
  ...
  return (
    <html lang="es" suppressHydrationWarning className={PROJECT_SETTINGS.defaultTheme}>
      <head>
