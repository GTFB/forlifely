...
import RoleAuthGuard, {getMeUser} from "@/components/guards/RoleAuthGuard"
...
export default function MLayout({ children }: { children: React.ReactNode }) {
    ...
    const userName = me?.user?.email || 'Гость'
    ...
    return ( <RoleAuthGuard allowedRaids={["manager", "Administrator"]}>
      <StoreKeeperProvider>
        <div className="">
